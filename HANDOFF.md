...
2026-09-11 at `9f12d23` (T381 close-out) · **Branch:** `main` ·
...
| Fact                             | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| HEAD                             | `d44fc0f` — "T386 follow-up: the rail's own 'Sessions' heading came out; refresh HANDOFF §1"; the commit you are reading is one past it. The wave's five commits: `9afc612` (T384 + T385, Android chrome/Sessions/Live/chat), `bf47161` (T386, the web console), `aea1248` (T387, inline extension elements), `34509d5` and `d44fc0f` (the two T386 follow-ups)                                                                                                                                                                                                                                                                                                                                                                                                         |
| CI (green)                       | run `34645663675` at `c05016d` — **completed / success**, 44 jobs (42 success, 2 skipped by the path filters), zero failures: `changes` (the `scripts/ci` guard suite), `typecheck`, `lint`, every repo guard, `web-unit-tests` on ubuntu + windows, `web-tests` (Playwright), `server-tests` on ubuntu + windows, `android-tests`. The run before it, at `d44fc0f` (`34644982421`), went red in `changes` alone: `guard-format-check-per-commit.test.mjs`'s real-git fixture asserts `git rev-parse --is-shallow-repository` is `false`, and the history rewrite left that runner fetching `--depth=1`, so the history it needs was genuinely absent from that checkout. The same suite passes on this tree locally (895/895). Prior green: `34596653634` at `9344932` |
