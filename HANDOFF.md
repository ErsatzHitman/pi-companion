...
| Fact                             | Value                                                                                                                                                                                                                                                                                                                                                                                                                      |
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| HEAD                             | `9f12d23` — "T381 close-out: observed-flow headers name dispatch 34589238596; ledger records the split decision", pushed to `origin/main`. T380 (`d11a6cb`), T381 (`a94012d`), T382 (`c49bf0e`) all landed since the last refresh                                                                                                                                                                                          |
| CI for `9f12d23`                 | run `34592330251`: red on `format` ONLY (this ledger's own list indentation, fixed in the commit carrying this refresh). All tests, typecheck, lint and every other guard green; Maestro `34592333116` on the same commit 9/9 green. Prior: `34589235657` for `a94012d`, success                                                                                                                                           |
| Last Maestro dispatch            | run `34589238596` at `a94012d`, **every job green including the new `maestro-non-gating` observation job** — `[run-shard] file-download: PASS`, `[run-shard] queue-retry-compaction: PASS`. The ten §14.4 flows still all `PASS`; `shards.json` untouched. A further dispatch on `9f12d23` is in flight at the time of writing                                                                                             |
| The dispatch before it           | run `34573541455` (T378 wave), every job green                                                                                                                                                                                                                                                                                                                                                                             |
...
| Working tree                     | clean                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Ledger                           | `docs/issues-from-plan.md` has rows and sections through T382 (591 tasks), counted from the table's own rows at the commit this refresh landed in. T381's section records the split decision; the next approved work is the three Supernova adoptions (project `memory.md`)                                                                                                                                                |
