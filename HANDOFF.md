...
| Fact                             | Value                                                                                                                                                                                                                                                                                                                                                                                                                      |
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| HEAD                             | `891d6d5` — "T386 follow-up: the rail's own 'Sessions' heading came out; refresh HANDOFF §1", pushed to `origin/main`. The wave's five commits are `9afc612` (T384 + T385, Android chrome/Sessions/Live/chat), `bf47161` (T386, the web console), `aea1248` (T387, inline extension elements), `34509d5` (T386 follow-up, the session column's heading and definition list) and `891d6d5`                                  |
| CI for `891d6d5`                 | read it with `gh run list --branch main --limit 3` before trusting this row; the wave's first push (`2113e4b`, superseded by the rebase below) went red on the `guard / format:check per commit` job only, and `aea1248`'s own rebase repaired it. Prior green: `34596653634` at `9344932`                                                                                                                                 |
| Last Maestro dispatch            | run `34643496389`, dispatched for this wave's Android changes (chrome, Sessions, Live, chat, extension rendering). Its predecessor `34592333116` at `9f12d23` was 9/9 green including `maestro-non-gating`                                                                                                                                                                                                                 |
