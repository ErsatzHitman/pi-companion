...
import { TerminalInputModeTracker } from "@picompanion/protocol/terminal-input-mode";
import { TerminalActivityTracker } from "./activity/terminal-activity-tracker.js";
import type {
  TerminalActivity,
  TerminalActivityState,
} from "@picompanion/protocol/terminal-activity";

const { Terminal } = xterm;
const require = createRequire(import.meta.url);
const PASEO_CLI_BIN_ENTRY = "@picompanion/cli/bin/paseo";
