...
describe("migrateProviderSettings", () => {
  // Pi is the only built-in provider in this repository, so the migration input
  // must agree with ProviderOverridesSchema's built-in list.
  const builtinProviderIds = ["pi"];
