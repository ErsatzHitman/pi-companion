...
export type { MutableDaemonConfig, MutableDaemonConfigPatch } from "@picompanion/protocol/messages";

type MutableDaemonConfig = import("@picompanion/protocol/messages").MutableDaemonConfig;
type MutableDaemonConfigPatch = import("@picompanion/protocol/messages").MutableDaemonConfigPatch;
