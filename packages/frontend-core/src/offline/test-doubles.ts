 ...
 * by this domain's tests. Kept local to `offline/` (mirrors
 * `composer/test-doubles.ts`) rather than in `testing/` (a T24 stub —
 * see that module's header) so this task does not add cross-domain
 * fixture logic outside its own scope.
 */
